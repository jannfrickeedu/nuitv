% rebase('layout', title='NuiTV', body_class='min-h-screen bg-nui-bg')
  ...
  <div class="flex flex-col items-center justify-center min-h-screen px-6 gap-6">
    ...
    <div class="w-full max-w-md flex flex-col gap-3">
      ...
      <div class="flex justify-between gap-2">
        <a href="/likes" class="px-5 py-2 rounded-full bg-nui-dark border border-nui-border text-nui-subtle text-sm">Meine Likes</a>
